...
const Contact = () => {
    ...
    const sendEmail = (e) => {
        ...
        emailjs
            .sendForm('service_rrmafge', 'template_usnwf69', form.current, {
                ...
                <div className="contact__content">
                    ...
                    <div className="contact__info">
                        <div className="contact__card">
                            ...
                            <span className="contact__card-data">amberkar.rohan17@gmail.com</span>
                            <a href="mailto:amberkar.rohan17@gmail.com" className="contact__button">Write me {" "}<i className="bx bx-right-arrow-alt contact__button-icon"></i></a>
                        </div>
                    </div>
                </div>
